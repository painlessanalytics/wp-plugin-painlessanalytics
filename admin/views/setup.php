...
<div class="painlessanalytics-form-setup">
    ...
    <a class="painlessanalytics-setup-link" href="#" onclick="return painlessanalyticsSetupLink(this)"><?php echo __('Have a Painless Analytics embed code?', 'painlessanalytics'); ?></a>
    <?php } else if ( !$enabled ) { ?>
    <h3 id="painlessanalytics-status"><?php echo __( 'Analytics Status', 'painlessanalytics' ); ?></h3>
    <p class="painlessanalytics-p-error">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
  <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"/>
</svg>
    <?php echo __('Painless Analytics is NOT enabled on your site', 'painlessanalytics'); ?></p>
    <?php } else { ?>
    <h3 id="painlessanalytics-status"><?php echo __( 'Analytics Status', 'painlessanalytics' ); ?></h3>
    ...
    <?php echo __('Painless Analytics is enabled on your site', 'painlessanalytics'); ?></p>
    <?php } ?>
    ...
    <form action="options.php" method="post">
        ...
        <h3 id="painlessanalytics-enter-setup-token"><?php echo __( 'Painless Analytics embed code', 'painlessanalytics' ); ?></h3>
        <div class="painlessanalytics-input-row">
            <textarea id="embed" name="painlessanalytics[embed]" rows="10" type="text" class="painlessanalytics-textbox" placeholder="<?php echo __( 'Embed Code', 'painlessanalytics' ); ?>" class="regular-text code" aria-labelledby="painlessanalytics-enter-setup-token"
